    ...
    <div className={`offcanvas offcanvas-start${isOpen ? ' show' : ''}`} tabIndex="-1" id="sidebar" aria-labelledby="sidebarLabel">
      ...
      <div className="offcanvas-body">
        <div className="nav flex-column ">
          <Link to="/meetings" className="nav-link text-decoration-none sidelink ">
            <FontAwesomeIcon icon={faCalendar} className='icons'/> Meetings
          </Link>
          <Link to="#playlist" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faMusic} className='icons' /> Playlists
          </Link>
          <Link to="#scheduler" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faClock} className='icons' /> Scheduler
          </Link>
          <Link to="#coaching" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faUser} className='icons' /> Coaching
          </Link>
          <Link to="#conversational-insights" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faComment} className='icons' /> Conversational Insights
          </Link>
        </div>
      
        <div className='bottom-nav mt-auto nav flex-column '>
          <Link to="#quick-start" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faCogs} className='icons'/>Quick Start
          </Link>
          <Link to="#settings" className="nav-link text-decoration-none sidelink">
            <FontAwesomeIcon icon={faCogs} className='icons' />Settings
          </Link>
          <Link to="#logout" className="nav-link text-decoration-none sidelink">
